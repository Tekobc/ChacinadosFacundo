  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        <PackageSearch size={28} className="text-blue-700" />
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Recepción de Materia Prima</h1>
          <p className="text-sm text-gray-500">Registro de recepciones y control organoléptico</p>
        </div>
      </div>
